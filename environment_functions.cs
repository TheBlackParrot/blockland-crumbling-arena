// http://forum.blockland.us/index.php?topic=276074.msg8211498#msg8211498
// like if you're going to remove an easy way for us to set the environment, at least make something default so we're not doing this crap
...
function setEnvironment(%varName, %value)
{
  ...
  case "GroundColor":
    ...
    if (isObject(GroundPlane))
    {
      ...
      Sky.renderBottomTexture = getWord(GroundPlane.color, 3);
...
function setEnvironmentTheme(%which) {
  switch$(%which) {
    case "dark":
      setEnvironment("DirectLightColor","0.05 0.05 0.05 1");
      setEnvironment("AmbientLightColor","0 0 0 1");
      setEnvironment("ShadowColor","0.01 0.01 0.01 1");
      setEnvironment("SunFlareColor","0 0 0 0");
      setEnvironment("FogColor","0 0 0 1");
      setEnvironment("SkyColor","0 0 0 1");
    case "default":
      setEnvironment("DirectLightColor","0.457944 0.457944 0.457944 1.000000");
      setEnvironment("AmbientLightColor","0.672897 0.672897 0.672897 1.000000");
      setEnvironment("ShadowColor","0.357477 0.357477 0.476636 1.000000");
      setEnvironment("SunFlareColor","1.000000 1.000000 1.000000 1.000000");
      setEnvironment("FogColor","1.000000 1.000000 1.000000 1.000000");
      setEnvironment("SkyColor","0.644860 0.878505 1.000000 1.000000");
  }
}